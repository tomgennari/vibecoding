...
export default function DonacionExitosaPage() {
  return (
    ...
    >
      ...
      >
        <div
          className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-6 text-4xl animate-bounce"
          style={{ background: 'rgba(124, 58, 237, 0.2)', border: `2px solid ${accent}` }}
        >
          🎉
        </div>
        ...
        <p className="text-base mb-8" style={{ color: textMuted }}>
          Tu aporte va directo a la construcción del Campus San Andrés.
        </p>
        <Link
          href="/dashboard"
