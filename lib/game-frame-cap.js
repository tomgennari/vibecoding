...
${FRAME_CAP_MARKER}
(function() {
  // Iframe viewport fix: window.inner* → document.documentElement.client*
  Object.defineProperty(window, 'innerWidth', {
    get: function() { return document.documentElement.clientWidth || window.screen.width; },
    configurable: true
  });
  Object.defineProperty(window, 'innerHeight', {
    get: function() { return document.documentElement.clientHeight || window.screen.height; },
    configurable: true
  });
  // Trigger resize after layout settles so renderers recalibrate
